...
export default function AuditLogsPage() {
  return (
    <div className="space-y-6 sm:space-y-8 pb-20">
      {/* Header Section */}
      <div className="bg-card p-4 sm:p-6 rounded-2xl sm:rounded-3xl border border-border shadow-sm overflow-hidden relative group">
        ...
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary border border-primary/20 mb-4">
             <ShieldCheck size={14} />
             <span className="text-[10px] font-bold uppercase tracking-wider">Security & Audit</span>
          </div>
          <h1 className="text-2xl sm:text-4xl font-bold text-foreground tracking-tighter uppercase">Audit Trails</h1>

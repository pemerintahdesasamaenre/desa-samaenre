...
export default function AdminStaffPage() {
  ...
  return (
    <div className="space-y-6 sm:space-y-8 pb-20">
      {/* Header Section */}
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 bg-card p-4 sm:p-6 rounded-2xl sm:rounded-3xl border border-border shadow-sm">
        <div>
          <h1 className="text-3xl sm:text-5xl font-bold text-foreground tracking-tighter uppercase leading-none">
        ...
        <Link 
          ...
          className="flex items-center justify-center gap-3 px-6 py-3 bg-primary hover:scale-105 text-primary-foreground rounded-full transition-all shadow-2xl shadow-primary/25 font-bold uppercase text-xs tracking-widest active:scale-95 w-full lg:w-auto"
        >
          <Plus size={20} />

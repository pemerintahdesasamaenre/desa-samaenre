      ...
      >
        ...
        <td className="px-3 sm:px-8 py-4">
          <div className="flex flex-col min-w-0">
            <span className="font-black text-foreground text-sm sm:text-base tracking-tight leading-tight">
              {post.title}
            </span>
        ...
        <td className="hidden lg:table-cell px-8 py-4 text-center">
          <span className="text-foreground font-black text-xs tabular-nums">{post.views}</span>
        </td>
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-center justify-between bg-background/50 p-3 rounded-xl border border-border/50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[8px] font-black text-muted-foreground uppercase tracking-widest">Publikasi</p>
                ...
                <div className="text-right">
                  ...
                  <p className={`text-[9px] font-black uppercase ${post.status === 'published' ? 'text-primary' : 'text-muted-foreground'}`}>{post.status}</p>
                </div>
              </div>

              {/* Action Buttons for Mobile */}
              <div className="flex flex-col gap-2 pt-2">
                <p className="text-[8px] font-black text-muted-foreground uppercase tracking-widest mb-1">Opsi Pengelolaan</p>

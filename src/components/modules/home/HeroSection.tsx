    ...
    <div className="relative h-[95vh] flex items-center justify-center overflow-hidden bg-background">
      ...
      <div className="relative z-20 max-w-6xl mx-auto px-4 text-center space-y-12">
        ...
        <div className="space-y-4">
          <h1 className="text-6xl md:text-9xl font-black tracking-tighter text-white dark:text-foreground leading-[0.85] animate-slide-up">
            Desa <br/>
        ...
        <p className={`text-xl md:text-2xl font-medium max-w-3xl mx-auto leading-relaxed animate-fade-in animation-delay-500 ${bannerUrl ? 'text-slate-200' : 'text-foreground'}`}>
          Mewujudkan tata kelola desa yang <span className="text-primary font-black border-b-2 border-primary/40">transparan</span>, 
          <span className="text-blue-400 font-black border-b-2 border-blue-400/40"> inovatif</span>, dan 
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-8 animate-fade-in animation-delay-700">
          <Link 
            href="/tentang" 
            className="w-full sm:w-auto px-12 py-5 bg-blue-600 text-white rounded-[2rem] font-black text-lg hover:scale-105 transition-all shadow-xl shadow-blue-500/20"
          >
            Jelajahi Profil
          </Link>
          <Link 
            href="/transparansi" 
            className="w-full sm:w-auto px-12 py-5 glass-premium text-white dark:text-foreground rounded-[2rem] font-black text-lg hover:bg-white/10 transition-all"
          >
            Lihat Anggaran
          </Link>
        </div>
